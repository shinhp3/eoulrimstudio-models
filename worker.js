 ...
 *
 * 역할: 관리자 로그인(/admin), STL 업로드·목록·삭제 API, records/tools API.
 * 공개 뷰어는 GitHub Pages(index.html) 사용. Worker 루트(/)는 Pages로 리다이렉트합니다.
 *
 * Secrets: ADMIN_PASSWORD, GITHUB_TOKEN, GITHUB_USERNAME, GITHUB_REPO (STL models),
 *          GITHUB_RECORDS_REPO (records.json 저장소)
 *
 * 업로드 후 생성되는 뷰어 링크는 VIEWER_BASE(GitHub Pages URL)를 따릅니다.
 */
...
<body>
  ...
  <script type="module">
    ...
    const PUBLIC_VIEWER_BASE = "https://shinhp3.github.io/eoulrimstudio-models";
